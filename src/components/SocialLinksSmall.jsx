...
const SocialLinksSmall = () => {
  ...
  return (
    <div className="lg:flex flex-col bottom-[5%] left-[30%] fixed">
      <ul className="flex">
        {links.map(({ id, child, href, style, download }) => (
          <li
            key={id}
            className={ "flex justify-between items-center sm:w-16 w-14 h-14 sm:px-4 px-2  hover:rounded-md duration-300 bg-gray-900" +
              " " +style
            }
          >
            <a
